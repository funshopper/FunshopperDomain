...
create table product (id bigint generated by default as identity, comment varchar(255), create_timestamp date, description varchar(255), link varchar(255), name varchar(255) not null, price double, update_timestamp date, category_id bigint, primary key (id))
alter table product add constraint FK1mtsbur82frn64de7balymq9s foreign key (category_id) references category
create table category (id bigint generated by default as identity, description varchar(255), name varchar(255), primary key (id))
create table product (id bigint generated by default as identity, comment varchar(255), create_timestamp date, description varchar(255), link varchar(255), name varchar(255) not null, price double, update_timestamp date, category_id bigint, primary key (id))
alter table product add constraint FK1mtsbur82frn64de7balymq9s foreign key (category_id) references category
...
create table product (id bigint not null, comment varchar(255), create_timestamp date, description varchar(255), link varchar(255), name varchar(255) not null, price double, update_timestamp date, category_id bigint, primary key (id))
alter table product add constraint FK1mtsbur82frn64de7balymq9s foreign key (category_id) references category
create sequence hibernate_sequence start with 1 increment by 1
create table category (id bigint not null, description varchar(255), name varchar(255), primary key (id))
create table product (id bigint not null, comment varchar(255), create_timestamp date, description varchar(255), link varchar(255), name varchar(255) not null, price double, update_timestamp date, category_id bigint, primary key (id))
